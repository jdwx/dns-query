 ...
 *
 */
class Updater extends Net_DNS2
{
    /*
     * a RequestPacket object used for the update request
     */
    ...
    public function __construct( string $zone, ?array $options = null )
    {
        ...
        //
        $this->_packet->header->opcode = Lookups::OPCODE_UPDATE;
    }
     ...
     *   master.
     *
     * @param RR $rr the RR object to be added to the zone
     *
     * @return bool
     * @throws Exception
     * @access public
    ...
    public function deleteAny( string $name, string $type ) : bool
    {
        ...
        $class = Lookups::$rr_types_id_to_class[
     ...
     *
     * @param ?ResponsePacket &$response ref to the response object or null to ignore response
     *
     * @return bool
     * @throws Exception
     * @access public
